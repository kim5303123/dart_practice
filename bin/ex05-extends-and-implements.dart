class Animal {
  ...
  //  Dart에서는 모든 클래스가 암시적으로 interface 역할을 할 수가 있다.
  //  별도의 interface 키워드 없음
  //  Dart에서는 abstract나 mixin으로 interface를 구현할 수 있다.
  //  extends 하면  상속,
